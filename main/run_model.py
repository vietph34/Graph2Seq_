...
from data_collector import read_data, vectorize_data
import utils as disk_helper
import numpy as np
...
if __name__ == "__main__":
    ...
    argparser.add_argument("-epochs", type=int, default=1000, help="training epochs")
